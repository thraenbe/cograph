  ...
  <div id="settings-panel">
    ...
    <div class="panel-section">
      ...
      <div class="slider-row">
        ...
        <input type="range" id="slider-link-thickness" min="1" max="8" step="0.5" value="1" />
      </div>
    </div>
    ...
    <div class="panel-section">
      ...
      <div class="slider-row">
        ...
        <input type="range" id="slider-center-force" min="0" max="1" step="0.01" value="0.1" />
      </div>
      <div class="slider-row">
        <div class="slider-header"><label for="slider-repel-force">Repel Force</label><span id="val-repel-force">2048</span></div>
        <input type="range" id="slider-repel-force" min="256" max="8192" step="64" value="2048" />
      </div>
      <div class="slider-row">
